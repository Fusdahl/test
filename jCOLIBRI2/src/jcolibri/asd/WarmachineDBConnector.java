...
public class WarmachineDBConnector implements Connector {
	...
	private String splitPunctuationForLast(String input) {
	...
	public void initFromXMLfile(URL file) throws InitializingException {
		try {
	        ...
	        descriptionClassName = splitPunctuationForLast(document.getElementsByTagName("DescriptionClassName").item(0).getTextContent());
	        ...
	        try{
		        ...
		        solutionClassName = splitPunctuationForLast(document.getElementsByTagName("SolutionClassName").item(0).getTextContent());
	        ...
	        try{
		        ...
		        justOfSolutionClassName = splitPunctuationForLast(document.getElementsByTagName("JustificationOfSolutionClassName").item(0).getTextContent());
	        ...
	        try{
		        ...
		        resultClassName = splitPunctuationForLast(document.getElementsByTagName("ResultClassName").item(0).getTextContent());
